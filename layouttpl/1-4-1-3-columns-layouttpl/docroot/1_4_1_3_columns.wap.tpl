<div class="1-4-1-3-column" id="main-content" role="main">
	<div class="portlet-layout portlet-style-1 row-fluid">
		<div class="portlet-column span12 portlet-column-only" id="column-1">
			$processor.processColumn("column-1", "portlet-column-content portlet-column-content-only")
		</div>
	</div>
	
	<div class="portlet-layout portlet-style-2 row-fluid">
	...
	<div class="portlet-layout portlet-style-3 row-fluid">
